	...
	return (
		<div className='offer__section6'>
			...
			<div className='offer__text'>
				Załakowo to niewielka wieś kaszubska w północnej Polsce. Miejscowość
				leży w województwie pomorskim w pobliżu Lęborka i Sierakowic. Właśnie w
				...
				ciszę, spokój i wypoczynek. Bliskość jeziora jest prawdziwym atutem tego
				miejsca. Kompleks wypoczynkowy powstał w 2014 roku i wykonany został z
				najwyższą starannością i dbałością o szczegóły. Otoczenie obiektu
				dopasowane jest do leśnego krajobrazu okolic jeziora Świętego.
				Uczestnicy obozu zostaną zakwaterowani w hotelu. Zajęcia odbywać się
				będą w budynku obok kompleksu hotelowego.
				<br></br>
