...
const PhysicsContent = () => {
  return (
    <>
      <div className="about">
        <h2 className="about__header header">O NAS</h2>
        <p className="about__text">
          ...
          <br />
          <br />
          W ramach Fizyki po godzinach uczestnicy będą mieli spotkania z dr hab.
          prof. UM w Gdyni Bogusławem Pranszke, które podzielone będą na zajęcia
          lekcyjne oraz na wykłady popularnonaukowe. Podczas zajęć uczniowie
          będą poszerzali wiedzę zdobytą podczas zajęć podstawowych, głównie
          poprzez rozwiązywanie bardziej złożonych problemów fizycznych pod
          okiem prowadzącego. W razie potrzeby możliwe jest również wprowadzanie
          na zajęciach bardziej złożonego aparatu matematycznego, który ułatwi
          szersze zrozumienie zagadnienia. Wykłady popularnonaukowe będą miłą
          odskocznią, od znojów codziennej szkolnej fizyki. Opierać się one będą
          głównie na zagadnieniach związanych z kosmosem i grawitacją. Nie
          wymagają one umiejętności matematycznych, ale pozwalają szeroko
          spojrzeć na omawiane zagadnienia oraz zrozumieć rys historyczny, który
          doprowadził do poszczególnych odkryć.
          <br />
          <br />
          ...
          angielskim wykorzystywanym w fizyce.
          <br />
          <br />
          Dodatkowo zorganizowane będą wyjazdy na Uniwersytet Morski w Gdyni,
          gdzie młodzież będzie uczestniczyła zarówno w zajęciach teoretycznych
          prowadzonychprzez pracowników tej uczelni jak i w zajęciach
          doświadczalnych.
        </p>
      </div>
      <div className="program-mobile">
        <h2 className="about__header header">PROGRAM</h2>
      ...
      <div className="participation">
        <h2 className="about__header header">UCZESTNICTWO</h2>
        <p>
