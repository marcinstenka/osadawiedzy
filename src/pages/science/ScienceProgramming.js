			...
			<div className='science-lecturers lecturers-programming'>
				...
				<div className='lecturers-container'>
					<div className='lecturer'>
						...
						<HashLink
							to={'/zespol#Wojciech-Malicki'}
							className='lecturer-more-info more-info-programming'
						>
							zobacz więcej
				...
				>
					<p className='science-text'>
						...
						<span className='science-color-programming'>Lęborku</span> oraz w{' '}
						<span className='science-color-programming'>Wejherowie</span>.
